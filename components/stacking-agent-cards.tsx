...
const AGENTS = [
  {
    ...
    desc: "Employees clock in and out from the mobile app or wristband. Working hours, late arrivals and corrections captured automatically.",
    stats: [{ v: "Real-time", l: "capture" }, { v: "Mobile", l: "clock-in" }],
  ...
  },
  {
    ...
    desc: "Build shifts, assign employees, and track regular and overtime hours across every site — with estimated earnings alongside.",
    stats: [{ v: "Regular", l: "+ overtime" }, { v: "Per-site", l: "scheduling" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "FATIGUE",
    title: "Fatigue risk monitoring",
    desc: "Biometric indicators combine with attendance and activity to surface fatigue risk — low, moderate or high — before incidents happen.",
    stats: [{ v: "Low·Mod·High", l: "risk levels" }, { v: "24/7", l: "signals" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "ACTIVITY",
    title: "Activity patterns",
    desc: "Understand operational patterns across teams, sites and shifts — grounded in real workforce activity, not guesswork.",
    stats: [{ v: "Team", l: "& site" }, { v: "Trends", l: "over time" }],
