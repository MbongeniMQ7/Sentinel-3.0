...
const THEMES: Record<Role, ShellTheme> = {
  ...
  manager: {
    label: "Manager",
    sidebar: "border-sky-950/50 bg-[#075985]",
    brandTitle: "text-white",
    brandSub: "text-sky-200/70",
    groupLabel: "text-sky-200/50",
    itemIdle: "text-sky-50/80 hover:bg-white/10 hover:text-white",
    itemActive: "bg-white text-[#075985] font-medium",
    itemActiveIcon: "text-[#075985]",
    itemIdleIcon: "text-sky-200/70",
    closeBtn: "text-sky-100 hover:bg-white/10",
  },
  employee: {
    label: "Employee",
    sidebar: "border-slate-200 bg-white",
