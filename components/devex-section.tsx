...
const STEPS = [
  {
    ...
    desc: "Set up your organisation",
    file: "onboarding / company",
    lang: "setup",
    code: [
      { type: "comment", text: "// Step 1 — Company" },
      { type: "output", text: "Set company name & logo" },
      { type: "output", text: "Add your first site" },
      { type: "output", text: "Choose your timezone" },
      { type: "gap" },
      { type: "success", text: "✓ Company ready" },
    ],
  },
  {
    num: "02",
    title: "Add your workforce",
    desc: "Invite managers & employees",
    file: "onboarding / workforce",
    lang: "setup",
    code: [
      { type: "comment", text: "// Step 2 — Workforce" },
      { type: "output", text: "Invite managers" },
      { type: "output", text: "Add employees" },
      { type: "output", text: "Assign roles & permissions" },
      { type: "gap" },
      { type: "success", text: "✓ Team invited" },
    ],
  },
  {
    num: "03",
    title: "Configure rules",
    desc: "Shifts, pay & fatigue rules",
    file: "onboarding / rules",
    lang: "setup",
    code: [
      { type: "comment", text: "// Step 3 — Rules" },
      { type: "output", text: "Define shifts & breaks" },
      { type: "output", text: "Set pay rates & overtime" },
      { type: "output", text: "Configure fatigue thresholds" },
      { type: "gap" },
      { type: "success", text: "✓ Rules configured" },
    ],
  },
  {
    num: "04",
    title: "Go live",
    desc: "Devices on, monitoring active",
    file: "onboarding / go-live",
    lang: "setup",
    code: [
      { type: "comment", text: "// Step 4 — Go live" },
      { type: "output", text: "Assign wristband devices" },
      { type: "output", text: "Turn on fatigue monitoring" },
      { type: "gap" },
      { type: "success", text: "✓ Workforce live" },
      { type: "url", text: "  → app.sentinelai.workforce" },
    ],
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Built for operations teams.<br />Rolled out in days.
          </h2>
        </div>
